This is the project related to course CT30A3204 Advanced Web Applications.
...
If the user is not logged in, only the home page is accessible. The login is done using JWT and cookies. 
